...
function Footer() {
  ...
  <strong className="Footer-Title-Para">Contact Us (Central Office)</strong>
       ...
       <li className='Footer-icon-item'><a href='https://www.youtube.com'>
       ...
       <li className='Footer-icon-item'><a href='https://www.twitter.com'>
       ...
       <li className='Footer-icon-item'><a href='https://www.pinterest.com'>
       ...
       <li className='Footer-icon-item'><a href='https://www.instagram.com'>
